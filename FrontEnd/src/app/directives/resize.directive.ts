...
import { Position } from 'angular-resize-element';
...
export class ResizeDirective implements OnInit, OnDestroy{
  private mouseClickListener: (() => void) | undefined;
    private mouseUpListener: (() => void) | any;
    private mouseMoveListener: (() => void) | any;

    private targetElementWidthValue: number | any;
    private targetElementHeightValue: number | any;

    private targetElementTopValue: number | any;
    private targetElementLeftValue: number | any;

    private originalEvent: MouseEvent | any;

    @Input()
    public targetElement: HTMLElement | ElementRef | any;

    @Input()
    public direction: AngularResizeElementDirection | any;

    @Input()
    public proportionalResize: boolean | any;

    @Input()
    public rect: Position | undefined;
